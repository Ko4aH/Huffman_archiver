...
FILE_NAME_IS_TAKEN_ERROR = 'Файл с именем выходного файла уже существует, укажите другое'
FILE_ALREADY_EXISTS_ERROR = 'Указанная папка уже содержит файл с таким же именем, укажите другую'
FILE_IS_CORRUPTED_ERROR = 'Файл повреждён и не может быть разархивирован'
SPECIFY_DIR_ERROR = 'Укажите папку для выходного файла'
SELECT_MODE_ERROR = 'Выберите один из режимов работы: архивация или деархивация, подробнее: -help'

HELP_MESSAGE = """
Данная программа позволяет архивировать файл при помощи кода Хаффмана.
Как пользоваться: 
python <имя программы> <файл для архивации или разархивации> [-d <путь>] [-a <путь>]
Параметры: 
-d - разархивация, после неё указывается папка для выходного файла;
