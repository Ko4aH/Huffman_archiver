...
class FileAfterUnzippingIsSame(unittest.TestCase):
    ...
    def test_on_empty_file(self):
        ...
        with open(empty_file, 'w') as f:
            f.write('Hello, world!')
        self.assertTrue(
            SomeMethods.check_if_file_and_unzipped_are_same(empty_file))
    ...
    def test_on_bin_file(self):
        ...
        f.close()
        self.assertTrue(
            SomeMethods.check_if_file_and_unzipped_are_same(bin_file))
...
class SomeMethods:
    ...
    @staticmethod
    def check_if_file_and_unzipped_are_same(file: str,
